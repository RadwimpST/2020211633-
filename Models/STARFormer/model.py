from Models.STARFormer.STARFormer import STARFormer
import torch
import numpy as np
...
class Model():
    ...
    def __init__(self, hyperParams, details):
        ...
        self.model = STARFormer(hyperParams, details)
    ...
    def step(self, x, y, train=True):
        ...
        # PREPARE INPUTS
        inputs, y = self.prepareInput(x, y) #inputs.shape = (batchSize, N, dynamicLength)
