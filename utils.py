...
def dumpTestResults(testName, hyperParams, modelName, datasetName, metricss):
    ...
    # write mean metrics per seed
    summaryMetricFile.write("\n MEAN METRICS PER SEED \n \n")
    summaryMetricFile.write("{}".format(meanMetrics_seeds))
    # write std metrics per seed
    summaryMetricFile.write("\n \n \n STD METRICS PER SEED \n \n")
    summaryMetricFile.write("{}".format(stdMetrics_seeds))
    # write mean metrics
    summaryMetricFile.write("\n MEAN METRICS \n \n")
